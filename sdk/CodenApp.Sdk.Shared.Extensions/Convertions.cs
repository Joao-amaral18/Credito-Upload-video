...
namespace System
{
    ...
    {
        public static Point ConvertToGeometry(this string coordinatesAux)
        {
        ...
        public static string RemoveCaracteresEspeciais(this string x)
        {
            if (x != null)
            {
                return x.Trim()
        ...
        public static string ContentTypeByExtension(this string arquivo)
        {
            string extension = arquivo.Substring(arquivo.LastIndexOf(".") + 1);
            switch (extension)
            {
        ...
        public static String ConcatDataUri(String caminhoArquivo, String base64)
        {
            string extensao = ContentTypeByExtension(caminhoArquivo);
            return $"data:{extensao};base64,{base64}";
        }

        public static string ContentTypeFromBase64(this string dataUri)
        {
